...
export THREATSTRYKER_VERSION?="2.5.4"
export TS_CONSOLE_HELM_CHART_VERSION?="2.5.4"
export TS_ROUTER_HELM_CHART_VERSION?="2.5.4"
export TS_AGENT_HELM_CHART_VERSION?="2.5.4"
export CLOUD_SCANNER_HELM_CHART_VERSION?="2.5.3"
export DF_IMG_TAG?="2.5.4"
