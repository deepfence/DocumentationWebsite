export THREATMAPPER_VERSION?="2.5.3"
export TM_CONSOLE_HELM_CHART_VERSION?="2.5.3"
export TM_ROUTER_HELM_CHART_VERSION?="2.5.3"
export TM_AGENT_HELM_CHART_VERSION?="2.5.3"
export THREATSTRYKER_VERSION?="2.5.3"
export TS_CONSOLE_HELM_CHART_VERSION?="2.5.3"
export TS_ROUTER_HELM_CHART_VERSION?="2.5.3"
export TS_AGENT_HELM_CHART_VERSION?="2.5.3"
export CLOUD_SCANNER_HELM_CHART_VERSION?="2.5.3"
export DF_IMG_TAG?="2.5.3"
