export THREATMAPPER_VERSION?="3.0.0"
export TM_CONSOLE_HELM_CHART_VERSION?="3.0.0"
export TM_ROUTER_HELM_CHART_VERSION?="3.0.0"
export TM_AGENT_HELM_CHART_VERSION?="3.0.0"
export THREATSTRYKER_VERSION?="3.0.0"
export TS_CONSOLE_HELM_CHART_VERSION?="3.0.0"
export TS_ROUTER_HELM_CHART_VERSION?="3.0.0"
export TS_AGENT_HELM_CHART_VERSION?="3.0.0"
export CLOUD_SCANNER_HELM_CHART_VERSION?="3.0.0"
