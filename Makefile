export THREATMAPPER_VERSION?="2.3.0"
export TM_CONSOLE_HELM_CHART_VERSION?="2.3.0"
export TM_ROUTER_HELM_CHART_VERSION?="2.3.0"
export TM_AGENT_HELM_CHART_VERSION?="2.3.0"
