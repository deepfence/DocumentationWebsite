...
ARG THREATSTRYKER_VERSION
ARG TS_CONSOLE_HELM_CHART_VERSION
ARG TS_ROUTER_HELM_CHART_VERSION
ARG TS_AGENT_HELM_CHART_VERSION
ARG THREATMAPPER_VERSION
ARG TM_CONSOLE_HELM_CHART_VERSION
ARG TM_ROUTER_HELM_CHART_VERSION
ARG TM_AGENT_HELM_CHART_VERSION
ARG CLOUD_SCANNER_HELM_CHART_VERSION
RUN set -eux \
    & apk add \
        --no-cache \
        nodejs \
